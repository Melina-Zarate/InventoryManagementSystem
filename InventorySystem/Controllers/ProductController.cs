...
namespace InventorySystem.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CategoryID,SupplierID,Name,Description,Price,Cost,Quantity")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CategoryID,SupplierID,Name,Description,Price,Cost,Quantity")] Product product)
        {
            if (ModelState.IsValid)
            {
